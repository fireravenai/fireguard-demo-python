...
from fireguard_create_conversation_v2 import create_conversation_v2
from fireguard_input_guardrail_v2 import check_input_guardrail_v2
from fireguard_output_guardrail_v2 import check_output_guardrail_v2
...
class OpenAIClient:
    ...
    def __init__(self, api_key: str):
        ...
        self.conversation_id = create_conversation_v2(
    ...
    def get_response(self, user_input: str) -> str:
        ...
        # Input Guardrail
        input_guardrails_response = check_input_guardrail_v2(
        ...
        try:
            ...
            # Output Guardrail
            output_guardrails_response = check_output_guardrail_v2(
                self.conversation_id,
